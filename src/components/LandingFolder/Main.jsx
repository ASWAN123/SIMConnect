...
function Main() {
  return (
    ...
    <div className="w-[55%] border flex flex-col gap-4 ">
      ...
      <Link to='/SIMConnect/signup'  className="ml-4 w-[250px] border px-6 py-2 text-lg text-white rounded-md bg-gradient-to-br from-blue-500 to-blue-300 text-center ">Start from 5$</Link>
    </div>
    <div className="w-[45%]">
