...
function Main() {
  return (
    ...
    <div className="flex-1 flex flex-col gap-4 ">
      <h1 className="text-[3rem] font-semibold">Welcome to <span className="text-blue-600">Networka</span> - Your Ultimate SIM Card Provider!</h1>
      ...
      <button className="ml-4 w-[250px] border px-6 py-2 text-lg text-white rounded-md bg-blue-600 ">Try For free</button>
    </div>
