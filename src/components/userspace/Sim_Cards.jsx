      ...
      <div className="flex gap-4 items-center justify-between mt-2 ml-4 text-[14px]">
        ...
        <div className="flex gap-2 ">
          ...
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-6 h-6 text-green-500 hover:cursor-pointer"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        >
          ...
          <div className="absolute flex flex-col w-full  pl-2 py-2 gap-2 ">
            <div className="flex flex-col gap-1 ">
              <p className="">
                SIM Card Status:{" "}
                <span className="text-green-500 pl-1">Active</span>{" "}
              </p>
              <p>
                Subscription Type:{" "}
                <span className="text-green-500 pl-1">Basic </span>
              </p>
            </div>
            ...
            <div className="flex flex-col gap-1 mt-4 ">
              ...
              <ul className="flex flex-col gap-1 ">
                <li className="text-gray-600 pl-1 flex gap-1 items-center ">
                  <MdOutline4GPlusMobiledata size={18} /> Data: 10 GB
                </li>
                <li className="text-gray-600 pl-1 flex gap-1 items-center ">
                  <IoCallSharp size={18} /> Minutes: 100 minutes
                </li>
                <li className="text-gray-600 pl-1 flex gap-1 items-center ">
                  <BiMessageRounded size={18} /> Messages: 50 messages
                </li>
              </ul>
            </div>
          </div>
